    ...
    <div class="min-h-screen">
        ...
        <div class="bg-amber-800 text-white p-4 shadow-md sticky top-0 z-10">
            <div class="container mx-auto flex items-center">
                <a href="{{ route('donante.menu') }}" class="mr-4 text-white">
        ...
        <main class="container mx-auto p-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <p class="text-gray-600 mb-6">Selecciona el artículo que deseas donar de los disponibles en nuestro
                    sistema</p>
                ...
                <form action="{{ route('donaciones.guardar') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500 mt-1 italic"
                            x-text="selected ? 'Número de presentaciones de ' + selected.cantidad + ' ' + selected.unidad + ' que deseas donar' : 'Selecciona un artículo primero'">
                        </p>
                    </div>
