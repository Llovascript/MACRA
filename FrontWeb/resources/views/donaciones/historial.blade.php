        ...
        <div class="bg-amber-800 text-white p-4 shadow-md sticky top-0 z-10">
            <div class="container mx-auto flex items-center justify-between">
                <div class="flex items-center">
                    <a href="{{ route('donante.menu') }}" class="mr-4 text-black">
                        <i class="fas fa-arrow-left"></i>
                    </a>
                    <h1 class="text-black font-bold">Mis Donaciones</h1>
                </div>
                <a href="{{ route('donaciones.crear') }}" class="text-black">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                @if (empty($donaciones))
                    <div class="text-center py-10">
                        ...
                        <a href="{{ route('donaciones.crear') }}"
                            class="inline-flex items-center bg-amber-800 hover:bg-amber-900 text-white font-semibold py-2 px-4 rounded">
