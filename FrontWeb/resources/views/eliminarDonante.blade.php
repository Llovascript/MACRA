...
<body>
    ...
    <script>
        ...
        const buscarUrl = "{{ route('buscar.donante.eliminar') }}";
        const eliminarUrl = "{{ route('eliminar.donante') }}";
        ...
        function cargarDatosUsuario(donante) {
            // Mapear campos según la estructura real de la BD
            document.getElementById('usuario_id').value = donante.id;
            document.querySelector('[name="nombre"]').value = donante.nombre || '';
            document.querySelector('[name="apellido_paterno"]').value = donante.aP || '';
            document.querySelector('[name="apellido_materno"]').value = donante.aM || '';
            document.querySelector('[name="email"]').value = donante.correo || '';
            document.querySelector('[name="edad"]').value = donante.edad || '';
            document.querySelector('[name="telefono"]').value = donante.telefono || '';
            document.querySelector('[name="rfc"]').value = donante.rfc || '';
            document.querySelector('[name="sitio_web"]').value = donante.paginaWeb || '';

            // Seleccionar opciones de los selects
            const tipoEntidadSelect = document.querySelector('[name="tipo_entidad"]');
            tipoEntidadSelect.value = donante.tipo || 'persona';
