    ...
    <div id="confirmModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-confirm delete" onclick="eliminarBeneficiario()">Eliminar</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function cargarDatosUsuario() {
            ...
            const userData = {
                ...
                rfc: 'MARE850315ABC',
                sitio_web: 'https://mariaelena.com',
                tipo_entidad: 'individual',
                tipo_perfil: 'donante_especie',
                password: '••••••••••••',
        ...
        function eliminarBeneficiario() {
            ...
            setTimeout(() => {
                ...
                // Redirigir a adminBeneficiarios después de eliminar
