...
<body>
    <div class="perfil-container">
        ...
        <div class="perfil-header">
            ...
            <h1 class="page-title">Perfil Beneficiario</h1>
        </div>

        <!-- Main Content -->
        <div class="main-content">
            <div class="form-container">
                <form class="beneficiario-form">
                    <!-- Datos personales -->
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="nombre" name="nombre"
                                    class="form-input beneficiario-field" readonly>
                            </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select id="estado" name="estado" class="form-select beneficiario-field">
                            ...
                            <div class="form-group">
                                ...
                                <select id="calles" name="calles" class="form-select beneficiario-field">
                                    <option value="">Seleccione...</option>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select id="municipio" name="municipio" class="form-select beneficiario-field">
                                    <option value="">Seleccione...</option>
                                    <option value="queretaro">Querétaro</option>
                                    <option value="corregidora">Corregidora</option>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select id="colonia" name="colonia" class="form-select beneficiario-field">
                                    <option value="">Seleccione...</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_exterior" name="no_exterior"
                                    class="form-input beneficiario-field" placeholder="123">
                            </div>
                        </div>
                        ...
                        <div class="form-row single-field">
                            <div class="form-group">
                                ...
                                <input type="text" id="codigo_postal" name="codigo_postal"
                                    class="form-input beneficiario-field" placeholder="76000">
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const requiredFields = [
                'estado', 'calles', 'municipio', 'colonia', 'no_exterior', 'codigo_postal'
            ];
            ...
            guardarBtn.addEventListener('click', function() {
                ...
                if (allFieldsComplete) {
                    ...
                    if (confirm(
                            '¿Estás seguro de que deseas guardar los cambios en el perfil del beneficiario?'
                        )) {
                        // Aquí puedes agregar la lógica para enviar los datos
                        alert('¡Perfil del beneficiario guardado exitosamente!');
