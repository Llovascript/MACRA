...
use App\Http\Controllers\AdminBeneficiariosController;
...
// Rutas principales de login y registro
...
// Rutas API para autenticación (AJAX)
...
Route::middleware(['auth.check:admin'])->group(function () {
    ...
    Route::get('/solicitudesPerfiles', [SolicitudesPerfilesController::class, 'index'])->name('solicitudesPerfiles');
    Route::get('/solicitudesDonaciones', [SolicitudesDonacionesController::class, 'index'])->name('solicitudesDonaciones');
...
/*
|--------------------------------------------------------------------------
| Rutas de Beneficiarios (rol_id = 3)
|--------------------------------------------------------------------------
*/
...
Route::middleware(['auth.check:beneficiario'])->group(function () {
    ...
    Route::get('/perfilBeneficiario', [BeneficiarioPerfilController::class, 'index'])->name('perfilBeneficiario');
...
Route::middleware(['auth.check:admin'])->prefix('admin')->group(function () {
    ...
    // === GESTIÓN DE DONACIONES (ESTRUCTURA DB) ===
